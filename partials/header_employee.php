<?php
    function echo_header_employee($item_active){
        ...
        if($item_active == "task"){
            echo '<li class="menu-items active-menu">
                <a href="./index.php" class="menu-link">Task</a>
            </li>';
        }else{
        ...
        if($item_active == "my_application"){
            echo '<li class="menu-items active-menu">
                <a href="./myapplication.php" class="menu-link">My application</a>
            </li>';
        } else{
            echo '<li class="menu-items">
                <a href="./myapplication.php" class="menu-link">My application</a>
        ...
        if($item_active == "my_information"){
            echo '<li class="menu-items active-menu">
                <a href="./myinformation.php" class="menu-link">My information</a>
            </li>';
        } else{
            echo '<li class="menu-items">
                <a href="./myinformation.php" class="menu-link">My information</a>
