...
<body>
    <div class="layout-container">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="table-operation">
                                    <button class="btn-refused" data-bs-toggle="modal" data-bs-target="#modal-refused">
                                        refused
                                    </button>
                                    <button class="btn-approved" data-bs-toggle="modal"
                                        data-bs-target="#modal-approved">
                                        approved
                                    </button>
                                </td>
                            </tr>
        ...
        <!-- modal refused  -->
        <div class="modal fade" id="modal-refused" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-danger">Refused</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- modal approved  -->
        <div class="modal fade" id="modal-approved" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
