...
<body>
    <div class="layout-container">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="table-operation">
                                    <a href="">See</a>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#modal-cancel-task">Cancel</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="modal fade" id="modal-cancel-task" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-danger">Cancel task</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- modal add task  -->
        <div class="modal fade" id="modal-add-task" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
